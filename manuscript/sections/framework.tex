...
\qquad H = \text{SHA-256},
\end{equation}
with $\rho_i$ a per-leaf blinding nonce, and the published value is the tree root.
This binds the pairs and the coins and prevents the audit from being gamed after the
fact, exactly as a flat hash of the whole manifest would; the tree structure buys one
