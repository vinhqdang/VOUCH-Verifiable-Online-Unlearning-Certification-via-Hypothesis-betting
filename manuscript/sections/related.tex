...
model to four bits resurrects forgotten knowledge; \citet{deeb2024remove} recover most
...
takes the first step by running attacks from \emph{outside} the declared class against
already-certified models and reporting where they exceed the tolerance. A
paraphrase-aware score in the spirit of \citet{li2026beliefs} is the natural next
