...
predicts. The most telling case
...
\emph{Ties.} Exact ties $D = 0$ occur in $0$ of $99{,}840$ scored pairs for
...
\begin{table}[t]
\centering\small
\caption{Attacks from outside the declared class $\F$, run against the $178$
