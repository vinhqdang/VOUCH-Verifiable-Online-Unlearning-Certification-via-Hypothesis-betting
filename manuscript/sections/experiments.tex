...
chance at all; the two-sided arm prices them correctly, and at $\eps = 0.05$ five of
the six retrain runs that fail to issue are held back by the \emph{lower} arm, not the
...
pairs, two seeds, and---this matters for the reading---\emph{every canary inserted
