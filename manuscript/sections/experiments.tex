...
It is worth diagnosing \emph{why} the stratum-restricted attack wins, because the
mechanism is mundane and bounds how far the result should be generalised. The
certificate is a statement about the cohort \emph{average}, and the $r = 8$ stratum
...
particular gap. Second, and less comfortably, the same logic applies to \emph{any}
heterogeneity the auditor can name, whether or not we planted it. The constructive
