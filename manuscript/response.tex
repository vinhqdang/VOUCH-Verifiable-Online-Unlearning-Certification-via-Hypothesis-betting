...
\item \textbf{The RMU tier is TOFU/GPT-2 only.} Three seeds, matching the main
benchmark tier, but reported separately rather than merged into it, and evaluated on
one benchmark and one architecture.
\end{enumerate}
