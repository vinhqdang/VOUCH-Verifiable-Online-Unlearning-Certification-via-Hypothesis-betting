...
Both targets are reported side by side in Tables~9 and 13 and we recommend reading them
together.
...
(\S6.10) and named it in the conclusion as the most important open problem the
framework faces.
...
coupling, but the condition is not met and we say so in Remark~3 and Appendix~A rather
